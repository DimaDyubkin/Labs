...
int main() {
    ...
    double sumOdd = SumOfOddIndex(arr, n);
    std::cout << "\nSum of elements at odd indices: " << sumOdd << "\n";

    double product;
    if (ProductBetweenNegatives(arr, n, product)) {
        std::cout << "Product between first and last negative: " << product << "\n";
    }
    else {
        std::cout << "Cannot compute product: not enough negative elements.\n";
    }
